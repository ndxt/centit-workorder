...
//或的上季度的结束日期
      function getLastQuarterEndDate(){
        var quarterEndMonth = getQuarterStartMonth() + 2;
        var quarterEndtDate = new Date(nowYear, quarterEndMonth, getMonthDays(quarterEndMonth));
        quarterEndtDate.setMonth(quarterEndtDate.getMonth()-3)
        return formatDate(quarterEndtDate);
      }
//获得今年的开始日期
...
//或的今年的结束日期
      function getYearEndDate(){
        var yearStartDate = new Date(nowYear, 11, 31);
        return formatDate(yearStartDate);
      }
//获得去年的开始日期
