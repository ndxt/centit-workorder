      ...
      'function' !== typeof n
        ...
        : ((function p() {
          return ++y > (1e3 * o.timeout) / 100
            ? a(e + ' timeout')
            : void (parseInt(i.getStyle(t.getElementById(c), "width")) ===
                  1989
              ? (function() {
                n();
              })()
          ...
          'function' === typeof a &&
              !(function c() {
                return ++d > 80
                  ...
                  : void (parseInt(t.getStyle(document.getElementById(l), "width")) ===
                    1989
                    ? a()
                    : setTimeout(c, 100));
              })();
...
!(function(e, t) {
  ...
  function A(e, t, n) {
    for (var r, i = t ? pe.filter(t, e) : e, o = 0; (r = i[o]) != null; o++)
  ...
  pe.extend({
    ...
    map: function(e, t, r) {
      ...
      else for (a in e) (o = t(e[a], a, r)), o != null && s.push(o);
      return oe.apply([], s);
    },
    guid: 1,
    proxy: function(e, t) {
  ...
  var ve = (function(e) {
    function t(e, t, n, r) {
      ...
      if (
        ((n = n || []),
        'string' !== typeof e || !e || (g !== 1 && g !== 9 && g !== 11))
      )
        {return n;}
      if (
        !r &&
    ...
    (L = t.setDocument = function(e) {
      ...
      return r !== H && r.nodeType === 9 && r.documentElement
        ? ((H = r),
        (q = H.documentElement),
        (_ = !E(H)),
        (n = H.defaultView) &&
  ...
  pe.extend({
    ...
    when: function(e) {
      var t,
        ...
        o = ie.call(arguments),
        a = o.length,
        s = a !== 1 || (e && pe.isFunction(e.promise)) ? a : 0,
        u = s === 1 ? e : pe.Deferred(),
        l = function(e, n, r) {
          return function(i) {
            (n[e] = this),
  ...
  pe(function() {
    ...
    n &&
          ...
          'undefined' !== typeof t.style.zoom &&
            ...
            (fe.inlineBlockNeedsLayout = e = t.offsetWidth === 3),
            e && (n.style.zoom = 1)),
          n.removeChild(r));
  }),
  (function() {
  ...
  pe.fn.extend({
    data: function(e, t) {
      ...
      if (void 0 === e) {
        if (
          this.length &&
            ((i = pe.data(o)), o.nodeType === 1 && !pe._data(o, 'parsedAttrs'))
        ) {
          for (n = a.length; n--;)
            {a[n] &&
                ((r = a[n].name),
  ...
  !(function() {
    ...
    (fe.leadingWhitespace = e.firstChild.nodeType === 3),
  ...
  pe.fn.extend({
    ...
    empty: function() {
      for (var e, t = 0; (e = this[t]) != null; t++) {
        for (e.nodeType === 1 && pe.cleanData(h(e, !1)); e.firstChild;)
    ...
    valHooks: {
      option: {
        get: function(e) {
          ...
          return t != null ? t : pe.trim(pe.text(e)).replace(jt, ' ');
        }
      },
      select: {
        get: function(e) {
  ...
  pe.extend({
    ...
    ajax: function(t, n) {
      ...
      if (
        ...
        {return T;}
      (l = pe.event && d.global),
      l && pe.active++ === 0 && pe.event.trigger('ajaxStart'),
      ...
      if (d.beforeSend && (d.beforeSend.call(p, T, d) === !1 || b === 2))
        {return T.abort();}
      w = 'abort';
      for (o in { success: 1, error: 1, complete: 1 }) T[o](d[o]);
      if ((c = U(Qt, d, n, T))) {
        if (((T.readyState = 1), l && h.trigger('ajaxSend', [T, d]), b === 2))
          {return T;}
        d.async &&
          d.timeout > 0 &&
  ...
  return (
    ...
    (pe.offset = {
      setOffset: function(e, t, n) {
        ...
        t.top != null && (d.top = t.top - s.top + a),
        t.left != null && (d.left = t.left - s.left + i),
          ...
          'function' === typeof i &&
              !(function u() {
                return ++c > 80
                  ...
                  : void (parseInt(o.getStyle(document.getElementById(f), "width")) ===
                    1989
                    ? i()
                    : setTimeout(u, 100));
              })();
      ...
      t(
        [
          ...
          '<div class="' +
              ...
              (r.type == 0 && r.icon !== -1 ? ' layui-layer-padding' : '') +
              (r.type == 3 ? ' layui-layer-loading' + r.icon : '') +
              '">' +
              (r.type == 0 && r.icon !== -1
                ...
                return (
                  r.closeBtn &&
                    (e +=
                      ...
                      ' ' +
                      l[7] +
                      (r.title ? r.closeBtn : r.type == 4 ? '1' : '2') +
                      '" href="javascript:;"></a>'),
                  e
                );
              })() +
  ...
  (s.pt.creat = function() {
    ...
    if (!t.id || !i('#' + t.id)[0]) {
      ...
      if (
        ...
        t.type == 2 && r.ie == 6 && e.layero.find('iframe').attr('src', s[0]),
        t.type == 4 ? e.tips() : e.offset(),
        t.fixed &&
    ...
    y = {
      ...
      tabAuto: function() {
        ...
        a('.layui-tab').each(function() {
          ...
          if (
            (n === window && t.ie != 8 && y.hideTabMore(!0),
...
layui.define('layer', function(e) {
  ...
  (p.prototype.upload = function(e, t) {
    ...
    switch (
      ((h = h.length === 0 ? r.value.match(/[^\/\\]+\..+/g) || [] || '' : h),
      l.accept)
    ) {
      case 'file':
...
layui.define(['laytpl', 'laypage', 'layer', 'form'], function(e) {
  ...
  (H.prototype.render = function(e) {
    ...
    a.height &&
        ...
        (a.height = L.height() - l.fullHeightGap));
    var r = (l.elem = t(
      i(T).render({ VIEW_CLASS: y, data: a, index: l.index })
    ));
    if (
      ((a.index = l.index),
      o[0] && o.remove(),
  ...
  (H.prototype.sort = function(e, i, a, n) {
    ...
    try {
      ...
      if (u.sortKey && !a && r === u.sortKey.field && i === u.sortKey.sort)
        {return;}
      var m = u.layHeader
        .find('th .laytable-cell-' + h.index + '-' + r)
        .find(C);
      u.layHeader
        .find('th')
        .find(C)
      ...
      var a = (function() {
        ...
        return (
          layui.each(t, function(t, i) {
            e[i] = window.location.origin + '/api/face/' + t + '.gif';
          }),
          e
        );
      })();
  ...
  .define(['layer', 'laytpl', 'upload'], function(i) {
    ...
    var x,
      ...
      O = function(i, a) {
        ...
        if (a) {
          i.hasClass(o) && O(n === 0 ? i.next() : i.prev());
      ...
      X = (function() {
        ...
        return (
          layui.each(i, function(i, e) {
            a[e] = window.location.origin + '/api/face/' + i + '.gif';
          }),
          a
        );
      })(),
