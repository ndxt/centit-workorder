...
alter table F_HELP_DOC add constraint FK_Reference_6 foreign key (CATALOG_ID)
      references F_QUESTION_CATALOG (CATALOG_ID) on delete restrict on update restrict;
...
alter table F_HELP_DOC_VERSION add constraint FK_Reference_1 foreign key (DOC_ID)
      references F_HELP_DOC (DOC_ID) on delete restrict on update restrict;
...
alter table F_HELP_DOC_COMMENT add constraint FK_Reference_2 foreign key (DOC_ID)
      references F_HELP_DOC (DOC_ID) on delete restrict on update restrict;
...
alter table F_HELP_DOC_SCORE add constraint FK_Reference_3 foreign key (DOC_ID)
      references F_HELP_DOC (DOC_ID) on delete restrict on update restrict;
...
alter table F_QUESTION_INFO add constraint FK_Reference_4 foreign key (CATALOG_ID)
      references F_QUESTION_CATALOG (CATALOG_ID) on delete restrict on update restrict;
...
alter table F_QUESTION_ROUND add constraint FK_Reference_5 foreign key (QUESTION_ID)
      references F_QUESTION_INFO (QUESTION_ID) on delete restrict on update restrict;
